...
export const STAGES: Stage[] = [
  {
    ...
    durationMs: 5000,
    description: 'Patient walks in. AI instantly begins checking insurance coverage.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    name: 'Consultation',
    durationMs: 4000,
    description: 'Doctor sees the patient. Normal consultation — 45 minutes pass.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    name: 'ClinicMate',
    durationMs: 5000,
    description: 'AI agents for the entire claims lifecycle. From patient walk-in to payment.',
  },
];
